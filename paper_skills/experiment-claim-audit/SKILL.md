...
|-------|-------------------|
| `/experiment-result-to-claim` | Does the data scientifically support this claim? |
| **`/experiment-claim-audit`** | **Does the paper report the data truthfully and precisely?** |
...
2. **After the local improvement pass** — recheck if the improvement pass changed numbers
