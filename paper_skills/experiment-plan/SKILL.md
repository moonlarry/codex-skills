...
description: "Turn a stable research proposal or method idea into a detailed, claim-driven experiment roadmap. Use after `paper-plan`, or when the user asks for a detailed experiment plan, ablation matrix, evaluation protocol, run order, compute budget, or paper-ready validation that supports the core problem, novelty, simplicity, and any LLM / VLM / Diffusion / RL-based contribution."
---
...
Use this skill after the method is stable enough that the next question becomes: **what exact experiments should we run, in what order, to defend the paper?** If the user wants the full chain in one request, compose `paper-plan`, `experiment-plan`, `experiment-ablation-planner`, `experiment-result-to-claim`, and `paper-writing` as needed.
...
- **OUTPUT_DIR = `paper/`** — Default destination for experiment planning artifacts.
...
- `paper/REVIEW_SUMMARY.md`
- user-provided idea, method, or result notes
...
#### Step 5.1: Write `paper/EXPERIMENT_PLAN.md`
...
#### Step 5.2: Write `paper/EXPERIMENT_TRACKER.md`
...
Plan file: paper/EXPERIMENT_PLAN.md
Tracker file: paper/EXPERIMENT_TRACKER.md
```
...
```
/paper-plan                  -> claim, section, evidence, and figure planning
/experiment-plan             -> detailed experiment roadmap
/experiment-ablation-planner -> focused ablation design after main results
/experiment-result-to-claim  -> judge completed results against claims
/paper-writing               -> turn confirmed evidence into a paper draft
```
